...
\For {$w \in vec$}
\Comment {Se calcula la posición del vecindario que mejor aproxima al sistema}
...
\Comment{Se agrega al vecindario sólo la posición que mejor aproxima la solución}
\end{algorithmic}
