...
direcciones. Estos fenómenos son aproximados usando un coeficiente de
...
del voumen. Esto significa que las técnicas usadas para renderizar
...
principal y desde estos puntos hacia la luz son
...
\begin{figure*}[htb!]
  ...
  \caption{Otros materiales renderizados en tiempo real con distintos parámetros. Izquierda.: budín, medio: torta, derecha.: esponja. }
...
simple. La información de profundidad de los fragmentos puede ser
obtenida de manera sencilla y por lo tanto pueden utilizarse técnicas
...
Otras posibles continuaciones a este trabajo incluyen mejorar el algoritmo de rendering, buscando tomar en cuenta iluminaci\'on indirecta y difusión de la luz dentro del material. Adem\'as, ecuaciones diferenciales m\'as generales ser\'an tratadas, para hacer posible una aplicaci\'on directa del modelo matem\'atico del proceso de cocci\'on. Otros materiales como quesos ser\'an investigados. Otra idea interesante ser\'ia definir primitivas de miga y carcaza para hacer posible un modelado art\'istico de estas caracter\'isticas. 
